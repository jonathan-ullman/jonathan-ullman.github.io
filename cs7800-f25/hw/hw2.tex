...
The best solution is to fire the laser at times $3,4$.  This solution blasts a total of $5$ tons of asteroids.
    ...
    % Consider an instance where $(x_1, x_2, x_3, x_4) = (1,2,100,2)$ and $(d_1, d_2, d_3, d_4)=(1,2,100,101)$. \textsc{BadLaser}$(1,2,100,2), (1,2,100,101)$ would shoot at time $4$ and blast $x_4=2$ tons of asteroids. Since the smallest number of years $j$ such that $d_j\geq 2$ is $j=2$, the recursive call would be \textsc{BadLaser}$(1,2), (1,2)$. The laser would choose to shoot again at time $2$ and blast another $x_2=2$ tons of asteroids. The smallest number of years $j$ such that $d_j\geq 2$ is $j=2$ so the algorithm would terminate. Overall $\textsc{BadLaser}$ would manage to destroy $4$ tons of asteroids. However, the optimal solution is to wait $3$ years and shoot at time $3$ blasting $100$ tons of asteroids. Therefore, \textsc{BadLaser} is not the right algorithm for this problem.
